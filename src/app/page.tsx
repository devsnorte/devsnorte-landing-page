  ...
  return <main className="">
    ...
    <Section.Container>
      ...
      <Section.Content variant="black">
        ...
        <Section.Info>
          Eventos de tecnologia (TI) são excelentes oportunidades para networking. Esses eventos reúnem pessoas de diversos setores da indústria, incluindo desenvolvedores, empresários, investidores, especialistas em marketing, designers, entre outros.
        </Section.Info>
      </Section.Content>
    </Section.Container>
    ...
    <Section.Container>
      ...
      <Section.Content variant="black">
        ...
        <Section.Info>
          Durante os eventos, a Devs Norte realiza sorteios de livros, cursos, e ferramentas utilizadas por programadores.
          Os sorteios são uma forma divertida de envolver os participantes e estimular a participação nos eventos. Eles também incentivam a comunidade de desenvolvedores a compartilhar ainda mais conhecimentos e recursos.
        </Section.Info>
      </Section.Content>
    </Section.Container>
