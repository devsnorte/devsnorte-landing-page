    ...
    const infos = [
        ...
        },
        {
            ...
            info: (
                <ul>
                    <li>
                        Jetbrains: <Link href="https://www.jetbrains.com/company/brand/">https://www.jetbrains.com/company/brand/</Link>
                    </li>
                    <li>
                        Faculdade Vincit: <Link href="https://www.faculdadevincit.edu.br/">https://www.faculdadevincit.edu.br/</Link>
                    </li>
                    <li>
                        Fanhero: <Link href="https://fanhero.com/pt-br/">https://fanhero.com/pt-br/</Link>
                    </li>
                    <li>
